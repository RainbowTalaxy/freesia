...
const Svg = {
    lyric: () => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" role="presentation">
            <mask id="uid-46">
            ...
            <rect width="100%" height="100%" mask="url(#uid-46)"></rect>
        </svg>
    ),
    lyricOn: () => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" role="presentation">
