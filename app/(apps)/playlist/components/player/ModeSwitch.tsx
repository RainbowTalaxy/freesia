...
import usePlayerStore, { PlayerMode } from '../../contexts/usePlayerStore';
import styles from './style.module.css';

const nextMode: { [key in PlayerMode]: PlayerMode } = {
    normal: 'loop',
    loop: 'single-loop',
    'single-loop': 'normal',
};
...
const ModeSwitch = () => {
    ...
    const switchMode = usePlayerStore((state) => state.switchMode);

    const active = mode !== 'normal';

    return (
        <button
            className={clsx(styles.toggle, styles.modeSwitch, active && styles.active)}
